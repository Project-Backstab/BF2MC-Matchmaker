...
--
-- Table structure for table `Leaderboard_ratio_kills_deaths`
--

DROP TABLE IF EXISTS `Leaderboard_ratio_kills_deaths`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Leaderboard_ratio_kills_deaths` (
...
-- Dump completed on 2024-06-08 11:56:37
