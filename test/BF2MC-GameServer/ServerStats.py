"""
    ...
    Explain values:
        fe fd 00 = request action
        fe b9 c2 8a = session token

        14                                                          = total request's
        01 06 03 04 10 0f 05 08 0a 0c 1c 18 33 34 35 36 37 38 39 3a = Request id's

    Reference:
        See functions:
            .text:005AC230      Handles the request and push the request data to .text:005ABDA0. The returned server status is then be send.
            .text:005ABDA0      
"""
...
SERVERSTATUS_REQUEST_ACTION = b'\xfe\xfd\x00'
...
def send(session_token, request_data_len, request_data):
    ...
    try:
        request = SERVERSTATUS_REQUEST_ACTION + session_token + request_data_len + request_data + b'\x00\x00'
